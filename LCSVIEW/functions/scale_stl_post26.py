...
l36stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L36.stl'])
...
SaveData('/Users/mark/LCS/ensight_files/CFD028/L36_scale.stl', proxy=transform1)
Hide(transform1, renderView1)

l80stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L80.stl'])
l80stlDisplay = Show(l80stl, renderView1)
transform1 = Transform(Input=l80stl)
transform1.Transform = 'Transform'
Hide3DWidgets(proxy=transform1)
transform1.Transform.Scale = [0.001, 0.001, 0.001]
transform1Display = Show(transform1, renderView1)
Hide(l80stl, renderView1)
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L80_scale.stl', proxy=transform1)
Hide(transform1, renderView1)

l90stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L90.stl'])
l90stlDisplay = Show(l90stl, renderView1)
transform1 = Transform(Input=l90stl)
transform1.Transform = 'Transform'
Hide3DWidgets(proxy=transform1)
transform1.Transform.Scale = [0.001, 0.001, 0.001]
transform1Display = Show(transform1, renderView1)
Hide(l90stl, renderView1)
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L90_scale.stl', proxy=transform1)
Hide(transform1, renderView1)



l56stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L56.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L56_scale.stl', proxy=transform2)
Hide(transform2, renderView1)

l55stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L55.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L55_scale.stl', proxy=transform3)
Hide(transform3, renderView1)

l57stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L57.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L57_scale.stl', proxy=transform4)
Hide(transform4, renderView1)

l70stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L70.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L70_scale.stl', proxy=transform5)
Hide(transform5, renderView1)

l730stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L730.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L730_scale.stl', proxy=transform6)
Hide(transform6, renderView1)

l780stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L780.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L780_scale.stl', proxy=transform7)
Hide(transform7, renderView1)


l781stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L781.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L781_scale.stl', proxy=transform8)
Hide(transform8, renderView1)


l902stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L902.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L902_scale.stl', proxy=transform9)
Hide(transform9, renderView1)


l901stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L901.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L901_scale.stl', proxy=transform10)
Hide(transform10, renderView1)

l903stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L903.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L903_scale.stl', proxy=transform12)
Hide(transform12, renderView1)


l904stl = STLReader(FileNames=['/Users/mark/Dropbox/Elemental Data for Mark T/CFD028/STL/L904.stl'])
...
transform12Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/mark/LCS/ensight_files/CFD028/L904_scale.stl', proxy=transform12)
Hide(transform12, renderView1)
