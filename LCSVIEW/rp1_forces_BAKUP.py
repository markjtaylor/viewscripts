...
initial_case = Volume_ensight(input_locate,path_name,input_vbles)
Hide(initial_case.master,initial_case.r_view)

rp1case = make_cp(initial_case,'p',20,input_locate)
...
rp1car = cut_od(rp1case,'Cp','negative')

#road = get_road(rp1case,'Cp','negative')
...
cp_colour = pseudo_scalar('Cp',-2.0,1.0)
