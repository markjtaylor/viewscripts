...
keyFrame17000.KeyValues = [0.02]
keyFrame17001.KeyValues = [1.10]
keyFrame17002.KeyValues = [0.02]
keyFrame17003.KeyValues = [1.10]
keyFrame17004.KeyValues = [0.02]
keyFrame17005.KeyValues = [1.10]
keyFrame17006.KeyValues = [0.02]
keyFrame17007.KeyValues = [1.10]
keyFrame17008.KeyValues = [0.02]
keyFrame17009.KeyValues = [1.10]
keyFrame17010.KeyValues = [0.02]
...
keyFrame18000.KeyValues = [0.02]
keyFrame18001.KeyValues = [1.10]
keyFrame18002.KeyValues = [0.02]
keyFrame18003.KeyValues = [1.10]
keyFrame18004.KeyValues = [0.02]
keyFrame18005.KeyValues = [1.10]
keyFrame18006.KeyValues = [0.02]
keyFrame18007.KeyValues = [1.10]
keyFrame18008.KeyValues = [0.02]
keyFrame18009.KeyValues = [1.10]
keyFrame18010.KeyValues = [0.02]
