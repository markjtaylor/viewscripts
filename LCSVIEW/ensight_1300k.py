...
path_name ='/ccm_naca12_1300k/naca12.case'
path_name = root_name + path_name

input_format = "ensight"
input_vbles = ['AbsolutePressure', 'Density', 'Pressure',  'WallShearStressi', 'WallShearStressj', 'WallShearStressk', 'Velocity', 'TurbulentViscosity', 'TurbulentKineticEnergy', 'TurbulentDissipationRate']
input_locate = "cell"
input_surfaces = [2]
...
velocity_colour = pseudo_scalar('Velocity',0.0,100.0)
