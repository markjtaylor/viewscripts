...
road_surface = make_plane(-1.5,-2.5,0.0,-1.5,2.5,0.0,7.0,-2.5,0.0,dark_grey,0.5)
...
Show(rtyres.master,ftyres.r_view)
Show(fwheels.master,fwheels.r_view)
Show(rwheels.master,rwheels.r_view)
Show(fwheelnuts.master,fwheelnuts.r_view)
Show(rwheelnuts.master,rwheelnuts.r_view)
