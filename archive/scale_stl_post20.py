...
l36stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L36.stl'])
...
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L36_scale.stl', proxy=transform1)
Hide(transform1, renderView1)

l50stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L50.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L50_scale.stl', proxy=transform1)
Hide(transform1, renderView1)

l51stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L51.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L51_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l52stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L52.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L52_scale.stl', proxy=transform1)
Hide(transform1, renderView1)



l53stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L53.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L53_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l54stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L54.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L54_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l58stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L58.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L58_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l60stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L60.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L60_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l61stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L61.stl'])
...
transform1Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L61_scale.stl', proxy=transform1)
Hide(transform1, renderView1)


l56stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L56.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L56_scale.stl', proxy=transform2)
Hide(transform2, renderView1)

l55stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L55.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L55_scale.stl', proxy=transform3)
Hide(transform3, renderView1)

l57stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L57.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L57_scale.stl', proxy=transform4)
Hide(transform4, renderView1)

l70stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L70.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L70_scale.stl', proxy=transform5)
Hide(transform5, renderView1)

l730stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L730.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L730_scale.stl', proxy=transform6)
Hide(transform6, renderView1)

l780stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L780.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L780_scale.stl', proxy=transform7)
Hide(transform7, renderView1)


l781stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L781.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L781_scale.stl', proxy=transform8)
Hide(transform8, renderView1)


l902stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L902.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L902_scale.stl', proxy=transform9)
Hide(transform9, renderView1)


l901stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L901.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L901_scale.stl', proxy=transform10)
Hide(transform10, renderView1)

l903stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L903.stl'])
...
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L903_scale.stl', proxy=transform12)
Hide(transform12, renderView1)


l904stl = STLReader(FileNames=['/Users/keritaylor/Dropbox/Elemental Data for Mark T/CFD020/STL/L904.stl'])
...
transform12Display.SetScalarBarVisibility(renderView1, True)
renderView1.ResetCamera()
SaveData('/Users/keritaylor/LCS/ensightfiles/CFD020/L904_scale.stl', proxy=transform12)
Hide(transform12, renderView1)
