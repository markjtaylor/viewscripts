...
fw271981case = EnSightReader(CaseFileName='/Users/keritaylor/LCS/ensightfiles/inp_naca0012/MESH_06M/fw271981.case')
fw271981case.CellArrays = ['AbsolutePressure', 'AbsoluteTotalPressure', '_MRL_CP', '_MRL_CP0', '_MRL_CP0_variance', '_MRL_CP_variance', 'Density', 'Pressure', '_MRL_RhoU', '_MRL_Swirl', '_MRL_TEMPC', '_MRL_UvelND', '_MRL_Vmag', '_MRL_VvelND', 'WallY', '_MRL_WvelND', '_MRL_aoa', '_MRL_aos', '_MRL_skinFriction', '_MRL_skinFrictionU', '_MRL_skinFrictionV', '_MRL_skinFrictionW', '_MRL_Velocity']
...
fw271981caseDisplay = Show(fw271981case, renderView1)
fw271981caseDisplay.SetScalarBarVisibility(renderView1, False)

# get color transfer function/color map for 'AbsolutePressure'
mRLCPLUT = GetColorTransferFunction('MRLCP')
mRLCPLUT.RGBPoints = [-3.0, 0.231373, 0.298039, 0.752941, -0.9496047496795654, 0.865003, 0.865003, 0.865003, 1.0, 0.705882, 0.0156863, 0.14902]
mRLCPLUT.ScalarRangeInitialized = 1.0

# Apply a preset using its name. Note this may not work as expected when presets have duplicate names.
mRLCPLUT.ApplyPreset('Blue to Red Rainbow', True)
...
extractSurface1 = ExtractSurface(Input=fw271981case)
...
clip1.ClipType.Bounds = [-5.625779151916504, 7.785420894622803, -1.2192000150680542, 1.3305601170076416e-16, -0.0003992804267909378, 0.8124006986618042]
clip1.ClipType.Position = [0.0, -0.001, 0.001]
...
# set scalar coloring
ColorBy(clip1Display, ('CELLS', '_MRL_CP'))
...
streamTracer1.SeedType.Point1 = [-0.1, -0.9, 0.3]
streamTracer1.SeedType.Point2 = [-0.1, -0.6, 0.3]
...
# set scalar coloring
ColorBy(slice1Display, ('CELLS', '_MRL_CP'))
...
# get color transfer function/color map for 'MRLCP'
mRLCPLUT = GetColorTransferFunction('MRLCP')
mRLCPLUT.RGBPoints = [-3.0, 0.0, 0.0, 1.0, 1.0, 1.0, 0.0, 0.0]
mRLCPLUT.ColorSpace = 'HSV'
mRLCPLUT.NanColor = [0.498039215686, 0.498039215686, 0.498039215686]
mRLCPLUT.ScalarRangeInitialized = 1.0
...
streamTracer2.SeedType.Point1 = [-0.3, -0.3, 0.2]
