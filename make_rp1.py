...
# set scalar coloring
ColorBy(car_scalarDisplay, ('CELLS', 'Pressure'))
...
bigwake.ContourBy = ['POINTS', 'VelocityMagnitude']
...
smallwake.ContourBy = ['POINTS', 'VelocityMagnitude']
